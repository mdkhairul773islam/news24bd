        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-5">
                        <input type="hidden" name="tags" id="mySingleField" value="Bangladesh, Pakistan">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10" style="min-height: 100px;">
                        ...
                        <textarea name="news" id="tinyTextarea" rows="20" cols="50" class="form-control"></textarea>
                    </div>
                </div>
                ...
                <div class="col-md-offset-2 col-md-5">
                    <div class="row">
                        <label><input type="checkbox" name="is_latest" value="1"> সর্বশেষ খবরের অন্তর্ভুক্ত হবে</label>
                    </div>
                </div>
