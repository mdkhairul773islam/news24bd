               ...
               <div class="row">
                   <div class="col-sm-12">
                        <div id="sortable" class="gallery image-gallery">
                            <?php if($gallery_data != NULL) { foreach ($gallery_data as $key => $gallery) { ?>
                                    ...
                                    <figcaption class="album-caption">
                                        ...
                                        <h6 class="privacy">
                                            <span class="right">
                                                ...
                                                <ul class="popup">
                                                    <li class="edit" data-title="<?php echo $gallery->gallery_title; ?>" data-id="<?php echo $gallery->id; ?>"><i class="fa fa-pencil-square-o"></i> <?php echo caption('Change_title'); ?> </li>
                                                    <li><i class="fa fa-trash-o"></i> <a onclick="return confirm('Are you sure to delete this Data ?')" href="?delete_token=<?php echo $gallery->id; ?>"><?php echo caption('Delete');?></a></li>
                                                </ul>
                                            </span>
                                        </h6>
                                    </figcaption>
                ...
                <div class="col-xs-12 no-padding">
                    ...
                    <div id="dyn_form">
                      <div class="form-group">
                          <label class="col-md-2 control-label"><?php echo caption('title');?> <span class="req">*</span></label>
                          <div class="col-md-5">
                              <input type="text" name="galleryTitle[]" class="form-control file" required placeholder="<?php echo caption('Maximum_100_Character');?>">
                          </div>
                      </div>
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-md-5">
                              <input id="" type="file" name="gallery_image[]" required class="form-control file" data-show-preview="true" required data-show-upload="false" data-show-remove="false">
                          </div>
                      </div>
                    </div>
                    ...
                    <div class="col-md-7">
                      <div class="btn-group pull-right">
                          <a id="addmore_btn" class="btn btn-success" href="" style="margin-right: 5px;"><?php echo caption('Add_More');?></a>
                          <input type="submit" name="gallery_Save" value="<?php echo caption('Save');?>" class="btn btn-primary">
                      </div>
                    </div>
  ...
  $(document).ready(function(){
    ...
    $(".edit").on('click', function() {
      ...
      if (edit_data!=null){
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('header/imageGallery/ajax_img_edit'); ?>",
