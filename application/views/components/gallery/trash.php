                                ...
                                <figure id="id<?php echo $key+1; ?>" data-mainid="<?php echo $gallery->id; ?>" data-position="<?php echo $gallery->position; ?>">
                                  <label class="selectbox" for="trash_check<?php echo $key; ?>">
                                    ...
                                    <figcaption style="display: flex;" >
                                        <a class="btn btn-primary" style="flex:1;" href="<?php echo site_url('gallery/'.$gallery->id); ?>"><?php echo caption('Restore'); ?></a><a class="btn btn-danger" onclick="return confirm('Are you sure to delete this Data ?')" href="?delete_token=<?php echo $gallery->id; ?>&img_url=<?php echo $gallery->gallery_path; ?>"><?php echo caption('Delete');?></a>
                                    </figcaption>
                                </figure>
                            <?php } ?>
                        </div>
        ...
        $('#sortable').sortable({
            ...
            stop: function(e, ui) {
              ...
              */
              ...
              $.ajax({
                  type: "POST",
                  url: "<?php echo site_url('gallery/ajax_img_sort'); ?>",
