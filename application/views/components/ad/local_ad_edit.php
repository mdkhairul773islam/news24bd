        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-5">
                        <input type="text" name="ad_link" value="" class="form-control" required >
                    </div>
                </div>
                ...
                <div class="col-md-7">
                    <div class="btn-group pull-right">
                        <input type="submit" value="আপডেট করুন" name="save" class="btn btn-primary">
                    </div>
                </div>
                <?php echo form_close(); ?>
            </div>
