            ...
            <div class="panel-body">
                 ...
                 ?>
                    ...
                    <legend><?php echo caption('Footer_Address');?></legend>
                        ...
                        <div class="form-group">
                            <label class=" col-md-2 control-label">নিউজ রুম মোবাইল</label>
                            <div class="col-md-5">
                                <input type="text" value="<?php echo $footer_info['addr_newsroom']; ?>" name="addr_newsroom" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class=" col-md-2 control-label">এডিটর-ইন-চিফ ইমেইল</label>
                            <div class="col-md-5">
                                <input type="text" value="<?php echo $footer_info['addr_editor']; ?>" name="addr_editor" class="form-control">
                            </div>
                        </div>
                    </fieldset>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                 ...
                 ?>
                    ...
                    <div class="form-group">
                        <label class=" col-md-2 control-label">ইউটিউব</label>
                        <div class="col-md-5">
                            <input type="text" value="<?php echo $social_icon['s_youtube']; ?>" name="s_youtube" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class=" col-md-2 control-label">প্লেস্টোর</label>
                        <div class="col-md-5">
                            <input type="text" value="<?php echo $social_icon['s_playstore']; ?>" name="s_playstore" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class=" col-md-2 control-label">আরএসএস</label>
                        <div class="col-md-5">
                            <input type="text" value="<?php echo $social_icon['s_rssFeed']; ?>" name="s_rssFeed" class="form-control">
                        </div>
                    </div>
