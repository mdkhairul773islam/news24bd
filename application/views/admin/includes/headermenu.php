<?php 
    ...
    $last_login = $this->action->read("login_log",array("id"=>"2"));
    $user_info = $this->action->read("users",array("username" => $last_login[0]->username));
?>
<style>
    .view-site:hover{
        color: #333;
...
<div id="page-content-wrapper">
    ...
    <div class="row">
        <nav class="col-xs-12 content-fixed-nav">
            <ul>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-left" aria-labelledby="message-menu">
                        <li class="dropdown-menu-description"><a>মেসেজ</a></li>
                        ...
                        <?php } ?>
                        <li class="divider"></li>
                        <li><a href="<?php echo site_url('visitors/comments'); ?>">মকল মেসেজ</a></li>
                    </ul>
                </li>
            ...
            <!--span style="line-height: 65px; float:left; color: #ADB7BE;" > Last login:  <?php echo $user_info[0]->name.", ".str_replace("_"," , ",str_replace("-"," / ",$last_login[0]->datetime)); ?></span-->
