...
<aside id="sidebar-wrapper">
    ...
    <nav>
        <ul class="sidebar-nav">
            ...
            <!--li id="adsance_menu" >
                <a href="#adsance" data-toggle="collapse">
                    <i class="fa fa-google"></i>
                    &nbsp;এডসেন্স
                    <span class="icon"><i class="fa fa-sort-desc"></i></span>
                </a>
                <ul id="adsance" class="sidebar-nav collapse">
                    <li>
                        <a href="<?php echo site_url('ad/ad/adsance'); ?>">
                            <i class="fa fa-angle-right"></i>
							নতুন এডসেন্স
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="<?php echo site_url('ad/ad/all_adsance'); ?>">
                            <i class="fa fa-angle-right"></i>
							সকল এডসেন্স
                        </a>
                    </li>
